  ...
  metrics:
    - overrides:
        - match:
          ...
          mode: SERVER # I am the receiver (upstream_peer is empty, downstream_peer is the caller)
          tagOverrides:
            caller_version:
...
## 4. How is this data exchanged? (ALPN)
This doesn't happen by magic. When two Envoys connect, they perform a **Business Card Swap** using the TLS ALPN extension.

For a deep dive into how Istio "injects" this metadata into the handshake, see the [Appendix: ALPN and Metadata Exchange](Appendix-ALPN-Metadata-Exchange.md).

---

## 5. Visualization: The "Metadata Mirror"
